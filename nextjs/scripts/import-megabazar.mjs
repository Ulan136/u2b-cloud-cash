// ⚠️ ВНИМАНИЕ: файлы 2025 и 2026 ПЕРЕКРЫВАЮТСЯ. Для ДОЛГОВ/КОНС/ЗАРПЛАТЫ файл 2026
// самодостаточен (перенос-остатки + полная история), а склейка обоих ЗАДВАИВАЕТ их.
// Долги/КОНС/зарплату импортируйте ТОЛЬКО из файла 2026 (см. fix-debts-kons-salary.mjs).
// Касса — можно оба файла (дедуп по датам max-модулем ниже корректен).
//
